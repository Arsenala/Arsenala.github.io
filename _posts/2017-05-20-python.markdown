...
![](/Users/jiaxuchao/Arsenala.github.io/img/python/4-1.jpg
)
...
![](/Users/jiaxuchao/Arsenala.github.io/img/python/4-2.jpg
)
...
![](/Users/jiaxuchao/Arsenala.github.io/img/python/4-3.jpg
)

但如果是纯计算的程序，没有I/O操作，解释器则会根据sys.setcheckinterval的设置来自动进行线程间的切换，默认是每隔100个内部时钟就会释放GIL锁从而轮换到其他线程：

![](/Users/jiaxuchao/Arsenala.github.io/img/python/4-4.jpg
)
...
![](/Users/jiaxuchao/Arsenala.github.io/img/python/4-5.jpg
)
